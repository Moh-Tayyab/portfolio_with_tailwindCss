...
const skills = [
  ...
  { name: "TypeScript", level: 90, icon: <SiTypescript color="#007ACC" /> },
...
export default function Skills() {
  ...
  useEffect(() => {
    // Generate 15 random bubble configurations
  ...
  return (
    <section className="relative bg-gradient-to-br from-gray-900 to-gray-800 min-h-screen flex items-center justify-center overflow-hidden">
      {/* Background Bubbles */}
      ...
      <div className="relative z-10 flex flex-col items-center py-12 px-4">
        <h2 className="text-6xl font-bold text-teal-400 mb-12 drop-shadow-lg">
          My Skills
        </h2>
