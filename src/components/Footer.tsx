        ...
        <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
          ...
          >
            <svg
              ...
              strokeWidth={2}
              className="w-10 h-10 p-2 bg-teal-500 rounded-full"
              viewBox="0 0 24 24"
            >
              <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" />
            </svg>
            <span className="ml-3 text-2xl font-semibold text-teal-400">
              Tayyab
            </span>
          </a>
          ...
          <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
            ...
            <a
              ...
              className="ml-3 text-gray-400 hover:text-teal-400"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
            ...
            <a
              ...
              className="ml-3 text-gray-400 hover:text-teal-500"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
